...
*/
    ...
    TRandom3 rand;
    rand.SetSeed(0);
    TFile *fAna = new TFile("DataAnalysisBunch"+bunchStr[i]+"TG_with_"+suff+".root","recreate");
    ...
    TH1F *xwidth1M_h = new TH1F("xwidth1M_h","xwidth1M_h",200,0.5,4.);
    xwidth1M_h->Fill(xWidthM1.getValV());
    TH1F *xwidth2M_h = new TH1F("xwidth2M_h","xwidth2M_h",200,0.5,4.);
    xwidth2M_h->Fill(xWidthM2.getValV());
    TH1F *ywidth1M_h = new TH1F("ywidth1M_h","ywidth1M_h",200,0.5,4.);
    ywidth1M_h->Fill(yWidthM1.getValV());
    TH1F *ywidth2M_h = new TH1F("ywidth2M_h","ywidth2M_h",200,0.5,4.);
