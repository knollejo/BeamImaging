...
void vdmScanTreeAnalyzerSGnoCorr_onData2_studyUnc_2016()
{
...
TRandom3 rand;
  rand.SetSeed(0);
 TFile *fAna = new TFile("DataAnalysisBunch"+bunchStr[i]+"noCorr_new_"+suff+".root","recreate");
